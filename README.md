...
3. **Inicie o servidor local**
    - O comando abaixo utiliza o npx para rodar o pacote serve, sem a necessidade de instalação global.
...
4. **Acesse no seu navegador**
    ...
    - Abra o endereço indicado no terminal. Geralmente o equivalente a http://localhost:3000.
